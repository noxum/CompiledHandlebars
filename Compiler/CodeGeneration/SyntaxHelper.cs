...
namespace CompiledHandlebars.Compiler.CodeGeneration
{
    ...
    internal static class SyntaxHelper
    {
        ...
        private static readonly ExpressionSyntax taskFromResult = SF.ParseExpression("Task.FromResult");
        private static readonly ExpressionSyntax sbToString = SF.ParseExpression("sb.ToString()");
        ...
        internal static ReturnStatementSyntax ReturnSBToString =
          SF.ReturnStatement(
             ...
             SF.AwaitExpression(SF.InvocationExpression(taskFromResult).AddArgumentListArguments(SF.Argument(sbToString))),
        ...
        /// </summary>
        internal static MethodDeclarationSyntax RenderWithParameter(string typeName, string methodName = "RenderAsync")
        {
            return
        ...
        /// </summary>
        internal static MethodDeclarationSyntax RenderWithoutParameter(string methodName = "RenderAsync")
        {
            return
                SF.MethodDeclaration(
                    new SyntaxList<AttributeListSyntax>(),
        ...
        /// <returns></returns>
        internal static ExpressionStatementSyntax AppendFuntionCallResult(string functionName, IList<string> parameters, bool returnTypeIsString, bool encoded, bool doAwait)
        {
        ...
        /// <param name="memberName"></param>
        /// <returns></returns>
        internal static ExpressionStatementSyntax HbsTemplateCall(string templateTypeName, string memberName, string methodName = "RenderAsync")
        {
            return
              SF.ExpressionStatement(
