...
namespace CompiledHandlebars.CompilerTests
{
    ...
    public class BasicCompilerTests : CompilerTestBase
    {
        ...
        [TestMethod()]
        [RegisterHandlebarsTemplate("EqualsTest", @"{{#equals Name Name}}HasName{{/equals}}", _marsModel)]
        public void EqualsTest()
        {
            ShouldRender("EqualsTest", MarsModelFactory.CreateFullMarsModel(), "HasName");
            ShouldRender("EqualsTest", new MarsModel(), "");
        }

        [TestMethod()]
        [RegisterHandlebarsTemplate("EqualsElseTest", @"{{#equals Name Name}}NameIsName{{else}}NameIsNotName{{/equals}}", _marsModel)]
        public void EqualsElseTest()
        {
            ShouldRender("EqualsElseTest", MarsModelFactory.CreateFullMarsModel(), "NameIsName");
            ShouldRender("EqualsElseTest", new MarsModel(), "NameIsName");
        }
